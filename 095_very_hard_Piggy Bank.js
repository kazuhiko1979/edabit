...
function num_of_days(cost, savings, start) {
    let current_amount = start;
    let current_savings = savings;
    let days = 0;
...
console.log(num_of_days(2050, 1200, 10));
console.log(num_of_days(10000, 2500, 50));
console.log(num_of_days(3333, 1111, 22));
console.log(num_of_days(1000, 100, 0));
console.log(num_of_days(19999, 5000, 5));
console.log(num_of_days(500, 300, 50));
console.log(num_of_days(7000, 6500, 250));
