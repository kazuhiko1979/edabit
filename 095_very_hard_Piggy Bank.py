...
def num_of_days(cost, savings, start):
    ...
    while current_saving <= cost:
        current_saving += current_amount
        current_amount += 1
        days += 1
        if days % 7 == 0:
            current_amount -= 6
...
print(num_of_days(3333, 1111, 22))
print(num_of_days(1000, 100, 0))
print(num_of_days(19999, 5000, 5))
print(num_of_days(500, 300, 50))
print(num_of_days(7000, 6500, 250))
#
