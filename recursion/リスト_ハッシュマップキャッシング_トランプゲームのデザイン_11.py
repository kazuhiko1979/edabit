"""
ブラックジャックでは最も多いスコアを獲得した人が勝利します。
そのため、ここでは誰が最も多いスコアを獲得したかを返す関数を記述していきます。
計算だけを行う、HelperFunctions クラスを定義して、その中に数値を受け取り最大値のインデックスを返す、
maxInArrayIndex メソッドを定義しましょう。
"""
import random
